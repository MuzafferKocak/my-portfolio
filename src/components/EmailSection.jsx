...
const EmailSection = () => {
  ...
  from-green-700 to-transparent rounded-full h-60 w-60 sm:h-80 sm:w-80 z-0 blur-lg 
  absolute top-[85%] sm:top-3/4 left-4 transform -translate-x-1/2 -translate-1/2"
      ></div>
      <div className="">
