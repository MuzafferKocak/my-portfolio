    ...
    <section>
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        <div className="col-span-5 place-self-center mt-4 lg:mt-0">
          <div className="rounded-full border border-green-400 bg-[#121212] w-[280px] h-[280px] lg:w-[380px] lg:h-[380px] relative">
            <Image
              src="/images/IMG_0759.JPG"
              alt="image"
              className="object-contain rounded absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
              width={300}
              height={300}
            />
          </div>
